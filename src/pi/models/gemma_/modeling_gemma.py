# coding=utf-8
"""Gemma model implementation with custom modifications for Pi."""
...
class GemmaRMSNorm(nn.Module):
    ...
    def forward(self, x, cond=None):
        ...
        # cond = cond.to(self.dense.weight.dtype)  # Convert cond to the same dtype as x
        # modulation = self.dense(cond).to(dtype=torch.float32)  # Keep modulation in float32
        modulation = self.dense(cond)
        # modulation = modulation.to(dtype=torch.float32)  # Ensure modulation is in float32
...
class GemmaForCausalLM(GemmaPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs: Unpack[KwargsForCausalLM],
        ...
        r"""Forward pass for causal language modeling.
...
class GemmaForSequenceClassification(GemmaPreTrainedModel):
    ...
    def forward(
        ...
        r"""Forward pass for sequence classification.
...
class GemmaForTokenClassification(GemmaPreTrainedModel):
    ...
    def forward(
        ...
        r"""Forward pass for token classification.
