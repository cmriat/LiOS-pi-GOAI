...
class PaliGemmaWithExpertModel(nn.Module):
    ...
    def forward(
        ...
        if inputs_embeds[1] is None:
            ...
            prefix_past_key_values = prefix_output.past_key_values  # 存储了每一层的 K/V 向量
            prefix_output = prefix_output.last_hidden_state #  最后一层隐状态[batch_size, seq_len, hidden_dim]
            suffix_output = None
